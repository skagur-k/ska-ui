		...
		<div className='flex flex-col gap-5'>
			<Collapsible title='Question 1'>
				...
				<Collapsible title='Question 1'>
					...
					Eveniet repellat a facilis libero reprehenderit, voluptatum
					magnam odio voluptas iusto est illo nobis saepe laborum,
					possimus adipisci cupiditate sunt inventore cumque.! Lorem
					ipsum dolor, sit amet consectetur adipisicing elit. Eveniet
					repellat a facilis libero reprehenderit, voluptatum magnam
					odio voluptas iusto est illo nobis saepe laborum, possimus
					adipisci cupiditate sunt inventore cumque.! Lorem ipsum
					...
					repellat a facilis libero reprehenderit, voluptatum magnam
					odio voluptas iusto est illo nobis saepe laborum, possimus
					adipisci cupiditate sunt inventore cumque.!
					<Avatar />
				</Collapsible>
			</Collapsible>
			<Collapsible title='Question 1'>
